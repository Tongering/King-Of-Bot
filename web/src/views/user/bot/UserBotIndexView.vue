...
<script>
import { ref, reactive } from "vue"; // 绑定变量用ref，绑定对象用reactive
import $ from "jquery";
...
export default {
    ...
    setup() {
        ...
        const refresh_bot = () => {
            $.ajax({
                url: "http://192.168.0.12:3000/user/bot/getlist/",
                type: "get",
                headers: {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "http://192.168.0.12:3000/user/bot/add/",
                type: "post",
                data: {
                    title: botadd.title,
        ...
        const update_bot = (bot) => {
            botadd.error_message = "";
            $.ajax({
                url: "http://192.168.0.12:3000/user/bot/update/",
                type: "post",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "http://192.168.0.12:3000/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
